...
replace (
	...
	github.com/moby/buildkit => github.com/earthly/buildkit v0.0.1-0.20220512205023-c193bef94053
	github.com/tonistiigi/fsutil => github.com/alexcb/fsutil v0.0.0-20220118225905-42fa88fbe869
)
